\subsubsection{Simulation of maximal parallel P system} % (fold)
\label{ssub:simulation_of_maximal_parallel_p_system}
...
% subsubsection simulation_of_maximal_parallel_p_system (end)