...
\begin{enumerate}
  ...
  \item\label{simple_skin_create} $x_j, t_i \rightarrow [_1 y_k, t_i ]_1$ for instruction $j: (add(i), k, \_)$,
...
\begin{enumerate}[resume]
  ...
  \item\label{simple_inner_create} $x_j, t_i \rightarrow [_1 y_k, t_i ]_1$ for instruction $j: (add(i), k, \_)$,
