...
The proof of the accepting case in section \ref{sub:universality_results_for_accepting_case} is more straightforward and correspond to a known result for Petri nets (\cite{Agerwala74}).
% TODO: need cite
