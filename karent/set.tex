...
\begin{example}
  ...
  The initial configuration will be $[_3 [_1 [_1 t_1 ]_1 ]_1 [_2 ]_2 t_2 x_1 ]_3$. Example computation:

  \begin{enumerate}
    \item $[_3 [_1 [_1 t_1 ]_1 ]_1 t_2 x_1 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_skin_send_down}
    \end{itemize}
    \item $[_3 [_1 [_1 t_1 ]_1 x_1 ]_1 t_2 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_inner_resend_down}
    \end{itemize}
    \item $[_3 [_1 [_1 t_1 x_1 ]_1 ]_1 t_2 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_inner_dissolve}
    \end{itemize}
    \item $[_3 [_1 t_1 y_2 ]_1 t_2 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_inner_resend_up}
    \end{itemize}
    \item $[_3 [_1 t_1 ]_1 t_2 y_2 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_skin_next_instruction}
    \end{itemize}
    \item $[_3 [_1 t_1 ]_1 t_2 x_2 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_skin_create}
    \end{itemize}
    \item $[_3 [_1 t_1 ]_1 [_2 t_2 y_1 ]_2 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_inner_resend_up}
    \end{itemize}
    \item $[_3 [_1 t_1 ]_1 [_2 t_2 ]_2 y_1 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_skin_next_instruction}
    \end{itemize}
    \item $[_3 [_1 t_1 ]_1 [_2 t_2 ]_2 x_1 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_skin_send_down}
    \end{itemize}
    \item $[_3 [_1 t_1 x_1 ]_1 [_2 t_2 ]_2 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_inner_dissolve}
    \end{itemize}
    \item $[_3 [_2 t_2 ]_2 t_1 y_2 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_skin_next_instruction}
    \end{itemize}
    \item $[_3 [_2 t_2 ]_2 t_1 x_2 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_skin_send_down}
    \end{itemize}
    \item $[_3 [_2 t_2 x_2 ]_2 t_1 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_inner_create}
    \end{itemize}
    \item $[_3 [_2 [_2 t_2 y_1 ]_2 ]_2 t_1 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_inner_resend_up}
    \end{itemize}
    \item $[_3 [_2 [_2 t_2 ]_2 y_1 ]_2 t_1 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_inner_resend_up}
    \end{itemize}
    \item $[_3 [_2 [_2 t_2 ]_2 ]_2 t_1 y_1 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_skin_next_instruction}
    \end{itemize}
    \item $[_3 [_2 [_2 t_2 ]_2 ]_2 t_1 x_1 ]_3$
    \begin{itemize}
      \item Use rule \ref{simple_skin_sub_empty}
    \end{itemize}
    \item $[_3 [_2 [_2 t_2 ]_2 ]_2 t_1 x_3 ]_3$
  \end{enumerate}
\end{example}
...
For a register machine with $m$ registers we will construct a seqeuntial active set P system, where $\Sigma = \{0,1,p,q,s,t\}\cup\{x_j, y_j, z_j \text{~for instructions with label~} j\}$. Skin membrane will be labeled with $m+1$, other labels correspond to registers 1 to $m$.
...
\begin{enumerate}[resume]
  ...
  \item\label{optim_inner_sub_1_highest_1} $x_j1tq \rightarrow y_k\uparrow 0t$ (exception to the rule \ref{optim_inner_sub_1_highest} - decrementing 1 to 0 does not decrement the number of bits),
