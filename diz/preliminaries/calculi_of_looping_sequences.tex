% !TEX root = ../diz.tex
Another tool for describing biological membranes is the formalism \index{Calculus of Looping Sequences} Calculus of Looping Sequences (CLS) \cite{Barbuti07CLS}.
