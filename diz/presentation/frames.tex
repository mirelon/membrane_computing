...
\begin{itemize}
  ...
  \item sekvenčný s prioritami (PsRE) \cite{Dang:2005:Sequential}
...
Pre maximálnom paralelizme je jedno, či máme pravidlá s prioritami, alebo nie.

TODO: mozno chcem dat do povodnej definicie priority

Pri sekvenčnom móde sa v každom kroku nedeterministicky vyberie pravidlo, ktoré sa raz aplikuje. Ibarra ukázal, že sekvenčné P systémy sa dajú simulovať pomocou vector addition systems, čiže nie sú univerzálne. Tiež ukázal, že s prioritami to uz je univerzálne.
