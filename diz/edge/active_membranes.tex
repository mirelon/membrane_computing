...
In this subsection we will focus on the problem of deciding whether there is a halting computation for sequential active P systems. Recall that halting computation has no applicable rule in the last configuration. We will chain reductions from the halting problem for deterministic register machines.
