...
In the section \ref{sec:preliminaries} we will recall some basic notions from formal languages, multisets and graph theory. Then in the section \ref{sec:p systems} we will introduce membrane structure and formally define membrane configuration and active P system because standard definitions are not convenient for our formal proofs.
