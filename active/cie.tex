...
We will reduce the problem of deciding existence of finite computation to the problem of reachability of a given configuration. For a given P system $\Pi$ and a target configuration $C$ we will construct a P system $\Pi^\prime$ such that there is a finite computation of $\Pi^\prime$ iff the $\Pi$ can reach configuration $C$.
