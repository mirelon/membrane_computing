...
First, we will reduce this problem to the reachability. It is a problem of determining, for a given configuration $C$, whether there exists a computation that contains $C$.
